...
(**
    Functions for parsing move programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a move program from a string into a typed OCaml CST.
...
(** Parse a move program from a file into a typed OCaml CST.
